...
BAD_WORDS_PATTERNS = {
    ...
    r'\b(ня|няшка|някать|нян)\b': [
        ...
        'Кто-то сказал «ня»? Пора гладить котиков! 🐈撫',
    ...
    r'\b(ямете|ямете кудасай|яметее)\b': [
        'ЯМЕТЕ КУДАСАЙ!! 😱💥',
        'А вот тут остановись, а то банахон прилетит! 🛑🙈',
    ...
    r'\b(хуесос|хуесосина|сосать|хуеплет|хуеплёт)\b': [
    ...
    r'\b(ебать|ебаться|трахнул|ебал|ебаный|ёбаный|в очке|ебнутый|ебанутый)\b': [
