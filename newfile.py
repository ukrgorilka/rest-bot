...
# --- СЛОВНИК МАТЮКІВ ТА СМІШНИХ ВІДПОВІДЕЙ ---
BAD_WORDS_PATTERNS = {
    r'\b(блять|бля|блеать|блят|бляя|блятьь)\b': [
    ...
    r'\b(пиздец|пизда|пиздос|пиздей|пиздато|пиздеть)\b': [
    ...
    r'\b(пидор|пидорас|пидарас|гандон|презерватив)\b': [
